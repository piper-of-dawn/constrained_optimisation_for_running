...
speeds = st.text_input("Enter speeds in KMPH (comma separated):", value="10.0, 11.5,12,13.5, 14.0, 14.5, 15,15.5")
speeds = [float(speed) for speed in speeds.split(",")]
speeds_constraints = st.text_input("Enter speed constraints (speed: [min_mins, max_mins], comma separated. All constraints should be enclosed within \{ \}. Make sure its a valid Python dict):", value="{10.0: [0, 26], 13.5: [1, 25], 14.0: [2, 7], 14.5: [1, 5], 15: [2, 3]}")
